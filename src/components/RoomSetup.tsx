  ...
  return (
    ...
    >
      ...
      <div className="mt-8 text-center text-sm text-gray-500">
        <p>Código-fonte disponível em <a href="https://github.com/seu-usuario/cartas-virtuais" className="text-blue-500 hover:underline">GitHub</a></p>
        <p className="mt-2">Convide seus amigos compartilhando o código da sala</p>
      </div>
    </motion.div>
  );
};
